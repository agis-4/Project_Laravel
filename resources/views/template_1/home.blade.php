...
<head>
  ...
  <link rel="stylesheet" href="{{url('css/sidelogo.css')}}">
  <link rel="stylesheet" href="{{url('css/sidew.css')}}">
  <!-- CSS Files -->
  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
          @include('template_1.sidebar')
      </div>    
    </div>

    <div class="main-panel">
      <!-- Navbar -->
      @include('template_1.header')
      <!-- End Navbar -->
      <div class="content">
